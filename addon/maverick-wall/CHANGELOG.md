...
wall's **Layout** settings now carry *Room between widgets*, seven steps wide.
**Normal** is what your wall draws today; **Snug**, **Tight**, **Very tight**
and **None** hand that room back to what is on the wall, and **Roomy** and
**Airy** go the other way — the widgets stop touching and the wall shows
between them, which on a theme that draws each widget as a card gives you real
gaps between the cards. Nothing changes until you pick one, and e-paper panels
size themselves and are not affected.
