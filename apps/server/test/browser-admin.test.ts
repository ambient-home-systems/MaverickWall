...
// ===========================================================================
// The Calendars screen: adding one
// ===========================================================================
 ...
 *
 * It lives in this file rather than its own deliberately. Every test *file* is
 * a separate vitest worker with its own Chromium, and `browser-classic-
 * proportions.test.ts` measures type sizes with a 1.4% margin against a first
 * draw that races the font load — a whole extra browser process alongside it
 * was enough to push its rota chip from 22px to 21.7px and turn it red.
 */
