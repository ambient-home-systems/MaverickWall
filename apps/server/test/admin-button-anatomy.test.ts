...
const PAGES = [
  ...
  // The two children that carry this family's own controls after RFC 014: the
  // connect form and its Disconnect, and the readings list with a Remove in
  // every ⋮. The hub keeps two cards and five rows and is still swept above.
...
describe('the card screens carry no inline layout style', () => {
  ...
  // in scope here.
  const CARD_PAGES = ['/admin', '/admin/walls', '/admin/modules', '/admin/people', '/admin/shifts/types', '/admin/chores', '/admin/themes', '/admin/alerts', '/admin/home-assistant', '/admin/home-assistant/readings', '/admin/system'] as const;
